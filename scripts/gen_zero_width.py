...
if __name__ == '__main__':
    path = '/path/to/utf8width/utf8width/table_zero.py'
    lines = open(path, 'r', encoding='utf-8').readlines()
    with open("../src/ZeroWidth.zig", 'w') as f:
        f.write(
...
pub fn init(version: UnicodeVersion) ZeroWidth {
    return .{ .version = version };
}

pub fn contains(self: ZeroWidth, codepoint: u21) bool {
