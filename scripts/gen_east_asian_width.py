...
if __name__ == '__main__':
    path = '/path/to/utf8width/utf8width/table_wide.py'
    lines = open(path, 'r', encoding='utf-8').readlines()
    with open("../src/EastAsianWidth.zig", 'w') as f:
        f.write(
...
pub fn init(version: UnicodeVersion) EastAsianWidth {
    return .{ .version = version };
}

pub fn contains(self: EastAsianWidth, codepoint: u21) bool {
